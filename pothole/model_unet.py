"""
U-Net model for pothole segmentation.
"""
...
class UNet(nn.Module):
    """
    U-Net model for binary segmentation (pothole detection).

    Args:
        n_channels: Number of input channels (3 for RGB, 4 for RGBA)
...
def create_model(n_channels: int = 3, pretrained_path: Optional[str] = None, device: str = "cpu") -> UNet:
    """
    Create a U-Net model, optionally loading pretrained weights.
